// this file was auto-generated by res2h at 2021-10-10 21:42:51

#include "Resources.h"

const uint32_t res2hNrOfFiles = 50;
const Res2hEntry res2hFiles[res2hNrOfFiles] = {
    {":/DejaVuSansMono.ttf", DejaVuSansMono_ttf_size, DejaVuSansMono_ttf_data},
    ...
    {":/help/analog.svg", help__analog_svg_size, help__analog_svg_data},
    ...
    {":/help/button_east.svg", help__button_east_svg_size, help__button_east_svg_data},
    ...
    {":/help/button_north.svg", help__button_north_svg_size, help__button_north_svg_data},
    ...
    {":/help/button_south.svg", help__button_south_svg_size, help__button_south_svg_data},
    {":/help/button_start.svg", help__button_start_svg_size, help__button_start_svg_data},
    {":/help/button_west.svg", help__button_west_svg_size, help__button_west_svg_data},
...
res2hMapType::value_type mapTemp[] = {
    std::make_pair(":/DejaVuSansMono.ttf", res2hFiles[0]),
    std::make_pair(":/arrow.svg", res2hFiles[1]),
    std::make_pair(":/busy_0.svg", res2hFiles[2]),
    std::make_pair(":/busy_1.svg", res2hFiles[3]),
    std::make_pair(":/busy_2.svg", res2hFiles[4]),
    std::make_pair(":/busy_3.svg", res2hFiles[5]),
    std::make_pair(":/button.png", res2hFiles[6]),
    std::make_pair(":/button_filled.png", res2hFiles[7]),
    std::make_pair(":/checkbox_checked.svg", res2hFiles[8]),
    std::make_pair(":/checkbox_unchecked.svg", res2hFiles[9]),
    std::make_pair(":/fav_add.svg", res2hFiles[10]),
    std::make_pair(":/fav_remove.svg", res2hFiles[11]),
    std::make_pair(":/frame.png", res2hFiles[12]),
    std::make_pair(":/help/analog.svg", res2hFiles[13]),
    std::make_pair(":/help/analog_left.svg", res2hFiles[14]),
    std::make_pair(":/help/analog_up.svg", res2hFiles[15]),
    std::make_pair(":/help/button_a.svg", res2hFiles[16]),
    std::make_pair(":/help/button_b.svg", res2hFiles[17]),
    std::make_pair(":/help/button_east.svg", res2hFiles[18]),
    std::make_pair(":/help/button_l.svg", res2hFiles[19]),
    std::make_pair(":/help/button_l2.svg", res2hFiles[20]),
    std::make_pair(":/help/button_north.svg", res2hFiles[21]),
    std::make_pair(":/help/button_r.svg", res2hFiles[22]),
    std::make_pair(":/help/button_r2.svg", res2hFiles[23]),
    std::make_pair(":/help/button_select.svg", res2hFiles[24]),
    std::make_pair(":/help/button_south.svg", res2hFiles[25]),
    std::make_pair(":/help/button_start.svg", res2hFiles[26]),
    std::make_pair(":/help/button_west.svg", res2hFiles[27]),
    std::make_pair(":/help/button_x.svg", res2hFiles[28]),
    std::make_pair(":/help/button_y.svg", res2hFiles[29]),
    std::make_pair(":/help/dpad_all.svg", res2hFiles[30]),
    ...
    std::make_pair(":/help/dpad_up.svg", res2hFiles[35]),
    std::make_pair(":/help/dpad_updown.svg", res2hFiles[36]),
    std::make_pair(":/off.svg", res2hFiles[37]),
    std::make_pair(":/on.svg", res2hFiles[38]),
    std::make_pair(":/opensans_hebrew_condensed_light.ttf", res2hFiles[39]),
    std::make_pair(":/opensans_hebrew_condensed_regular.ttf", res2hFiles[40]),
    std::make_pair(":/option_arrow.svg", res2hFiles[41]),
    std::make_pair(":/scroll_gradient.png", res2hFiles[42]),
    std::make_pair(":/slider_knob.svg", res2hFiles[43]),
    std::make_pair(":/splash.svg", res2hFiles[44]),
    std::make_pair(":/star_filled.svg", res2hFiles[45]),
    std::make_pair(":/star_unfilled.svg", res2hFiles[46]),
    std::make_pair(":/textinput_ninepatch.png", res2hFiles[47]),
    std::make_pair(":/textinput_ninepatch_active.png", res2hFiles[48]),
    std::make_pair(":/window_icon_256.png", res2hFiles[49])
};
